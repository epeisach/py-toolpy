...
def pdbtls_2cif(pdbfile):
    ...
    for i, x in enumerate(fp):
        ...
        #     prog = x.split(":")[1].strip()
            ...
            ("T11:" in x[14:20] and "T22:" in x[29:34])
            or ("T33:" in x[14:20] and "T12:" in x[29:34])
            or ("T13:" in x[14:20] and "T23:" in x[29:34])
            or ("L11:" in x[14:20] and "L22:" in x[29:34])
            or ("L33:" in x[14:20] and "L12:" in x[29:34])
            or ("L13:" in x[14:20] and "L23:" in x[29:34])
        ):
            tt = x.split(":")
    ...
    for ln in fp:
        ...
        if "ATOM" in ln[:4] or "HETATM" in ln[:6] or "ANISOU" in ln[:6]:
            ...
            if id == 1:
                cond = n == len(fp)
            if id == 2:
                cond = n == len(fp) or ch != fp[n][21:22]
            if cond:
